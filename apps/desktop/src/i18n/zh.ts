...
export const zh: Translations = {
  ...
  settings: {
    ...
    kanban: {
      ...
      boardsLoadFailed: '看板加载失败',
      boardLoadFailed: '看板加载失败',
      unavailableTitle: '看板不可用',
      unavailableDescription: '此配置文件未启用看板插件。',
      loadFailedTitle: '无法加载看板',
      loadFailedDescription: '请检查后端连接后重试。',
      retry: '重试',
      refresh: '刷新',
      boardCount: count => `${count} 个看板`,
      taskCount: count => `${count} 个任务`,
      current: '当前',
      emptyTitle: '没有看板',
      emptyDescription: '当前配置文件中没有看板。',
      loadingBoard: '正在加载看板…',
      noSelectionTitle: '未选择看板',
      noSelectionDescription: '请从左侧选择一个看板。',
      boardUnavailableTitle: '看板不可用',
      boardUnavailableDescription: '无法加载此看板。请选择其他看板或重试。',
      untitledTask: '未命名任务',
      moreTasks: count => `另有 ${count} 个`
    },
    notifications: {
      title: '通知',
    ...
    gateway: {
      ...
      profileConnection: profile => `仅当“${profile}”是当前 profile 时使用此连接。选择使用默认即可继承全局连接。`,
      useDefaultTitle: '使用默认连接',
      useDefaultDesc: '继承“所有 profile”中选择的连接。',
