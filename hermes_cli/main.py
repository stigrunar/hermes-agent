...
def _pull_with_divergence_recovery(
    git_cmd, cwd, branch, pre_pull_sha, *, remote="origin"
):
    ...
    return pull_with_divergence_recovery(
        git_cmd, cwd, branch, pre_pull_sha, remote=remote
    )
    ...
    try:
        ...
        try:
            recovery_result = _pull_with_divergence_recovery(
                git_cmd, PROJECT_ROOT, branch, pre_pull_sha, remote=remote
            )
