...
def _dispatch_once_locked(
    ...
    *,
    ...
    # creating a PR. The dispatcher spawns the configured review agent,
    # which verifies the PR and either merges (→ done) or rejects
    # (→ back to running for the worker to fix).
    #
