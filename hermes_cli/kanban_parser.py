...
_SPECS = [
    ...
    _cmd("dispatch", [
        ...
        _arg("--max", type=int, metavar="N",
             help="Cap live concurrency (running + new starts) for this pass"),
        _arg("--spawn-budget", type=int, metavar="N",
             help="Independently cap new worker starts in this pass"),
