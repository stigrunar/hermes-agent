...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("auth", "Manage credential pools from an authenticated messaging DM", "Configuration",
               gateway_only=True,
               args_hint="[list [provider]|status <provider>|reset <provider>|add openai-codex [--label name]]"),
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               "Tools & Skills", args_hint="[subcommand]",
               aliases=("kanban-list", "kanban_list"),
