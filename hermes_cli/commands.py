...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("auth", "Choose or authenticate an inference account", "Configuration",
               args_hint="[status|use <provider> <account>|reauth <provider> [account]|add <provider>]",
               subcommands=("status", "use", "reauth", "add"), busy_policy="reject",
               desktop="hidden"),
