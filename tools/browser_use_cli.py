...
def browser_exec(
    ...
    if effective_session:
        ...
        # Preserve this runtime descendant's browser-backend contract: unnamed
        # calls may resolve the configured shared provider/CDP endpoint, while
        # named harness sessions own their browser lifecycle directly.
