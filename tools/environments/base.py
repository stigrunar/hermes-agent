...
class BaseEnvironment(ABC):
    ...
    def _wrap_command(self, command: str, cwd: str) -> str:
        ...
        # snapshot and passthrough restoration, otherwise a prior command's
        # exported value wins. Local session metadata uses this hook; remote
        # backends keep the no-op.
