...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        #
        # Iteration exhaustion is non-retryable. Scoped workers persist the
        # terminal request here; dispatcher reconciliation reaps their exact
        # scope before releasing the claim and closing the run.
        ...
        if _kanban_task:
            try:
                ...
                try:
                    ...
                    logger.info(
                        "recorded iteration exhaustion for task %s (%d/%d)",
