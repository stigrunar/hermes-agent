...
KANBAN_GUIDANCE = (
    ...
    "Create `kanban_create(review_gate={"
    "source_task_id: $HERMES_KANBAN_TASK, candidate_sha: <full id>, "
    "candidate_tree: <full id>})` without `parents`, then "
    "`kanban_block(kind=\"review_gate\", reason=...)`. Reviewers copy the "
    "shown ids into `kanban_complete(review_receipt={verdict: \"approved\"|"
    "\"changes_requested\", candidate_sha: ..., candidate_tree: ...}, ...)`. "
    "Only exact approval releases. Prose, titles, "
    "comments, and `review-required:` blocks stay manual.\n"
